/**
 * Classe que representa uma operação de multiplicação.
 *
 * Esta classe fornece um método para realizar a operação de multiplicação entre dois números inteiros.
 *
